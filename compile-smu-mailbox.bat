...
set "INCLUDE=%WDK%\Include\%WINVER%\ucrt;%WDK%\Include\%WINVER%\shared;%WDK%\Include\%WINVER%\um;C:\AMD-BC-250\AMD-BC-250-PSP-Windows-Driver\inc;%INCLUDE%"
set "LIB=%WDK%\Lib\%WINVER%\ucrt\x64;%WDK%\Lib\%WINVER%\um\x64;%LIB%"
cl /nologo /Zi /O2 /W3 "test-tools\smu-mailbox-test.c" /Fe:"output\smu-mailbox-test.exe"
