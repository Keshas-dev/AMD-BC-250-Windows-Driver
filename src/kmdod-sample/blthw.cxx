...
--*/
{
...

    {
        ...
        // BC-250: Limit MDL mapping to 16 MiB to avoid exhausting system commit/paging-file quota
        // Large user-buffer locks can cause Code 31 (CM_PROB_FAILED_ADD / Not Enough Quota)
        if (sizeToMap > 64 * 1024 * 1024)
        {
            DbgPrintEx(DPFLTR_DEFAULT_ID, DPFLTR_ERROR_LEVEL, "BC-250: Present too large for MDL mapping - %u bytes (max 64 MiB)\n", sizeToMap);
