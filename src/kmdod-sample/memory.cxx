...
void* __cdecl operator new(size_t Size, POOL_TYPE PoolType)
{
    ...
    // ExAllocatePool2 takes POOL_FLAGS, not POOL_TYPE. NonPagedPool=0 and
    // PagedPool=1 are NOT valid flags (POOL_FLAG_NON_PAGED=0x40,
    // POOL_FLAG_PAGED=0x80); passing 0 returns NULL -> STATUS_NO_MEMORY (Code 31).
    POOL_FLAGS PoolFlags = (PoolType == PagedPool) ? POOL_FLAG_PAGED : POOL_FLAG_NON_PAGED;
    void* pObject = ExAllocatePool2(PoolFlags, Size, BDDTAG);
