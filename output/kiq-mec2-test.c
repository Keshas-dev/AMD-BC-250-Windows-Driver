...
#define IOCTL_SEND_PM4    0x80000BD4
...
int main() {
    ...
    printf("=== KIQ ring test with MEC2 firmware ===\n\n");
    ...
    printf("  KIQ_RPTR = 0x00000000\n");
    write_reg(0xE07C, 0x00000001);
    printf("  KIQ_VMID = 0x00000001\n");
    write_reg(0xE080, 0x00000001);
    printf("  KIQ_ACTIVE = 0x00000001\n");
    
    printf("\nKIQ registers after setup:\n");
    printf("  KIQ_BASE_LO = 0x%08X\n", read_reg(0xE060));
    printf("  KIQ_SIZE    = 0x%08X\n", read_reg(0xE068));
