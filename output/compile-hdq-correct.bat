...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\hdq-correct-test.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\hdq-correct-test.exe" user32.lib kernel32.lib
