...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\gcvm-offset-verify.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\gcvm-offset-verify.exe" advapi32.lib
if %errorlevel% neq 0 (echo BUILD FAILED & exit /b %errorlevel%)
echo BUILD OK: gcvm-offset-verify.exe
