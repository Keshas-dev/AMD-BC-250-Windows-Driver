...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\gpu-kiq-test.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\gpu-kiq-test.exe" user32.lib
if %errorlevel% neq 0 (echo BUILD FAILED & exit /b %errorlevel%)
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\test-kiq-submit.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\test-kiq-submit.exe" user32.lib
if %errorlevel% neq 0 (echo BUILD FAILED & exit /b %errorlevel%)
echo ALL OK
