...
cl /nologo /Fe:C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\probe-gfx-ring.exe C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\probe-gfx-ring.c /I C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\inc /I C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\src\kmd /link user32.lib
