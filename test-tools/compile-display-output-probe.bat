...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\display-output-probe.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\display-output-probe.exe" user32.lib gdi32.lib
