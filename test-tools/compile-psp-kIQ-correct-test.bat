...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\psp-kIQ-correct-test.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\psp-kIQ-correct-test.exe" user32.lib gdi32.lib
