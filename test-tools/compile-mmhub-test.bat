...
echo Compiling mmhub-1a144-test...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\mmhub-1a144-test.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\mmhub-1a144-test.exe" advapi32.lib
