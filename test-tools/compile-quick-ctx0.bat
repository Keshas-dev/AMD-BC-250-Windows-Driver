...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\quick-ctx0-check.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\quick-ctx0-check.exe" kernel32.lib user32.lib
