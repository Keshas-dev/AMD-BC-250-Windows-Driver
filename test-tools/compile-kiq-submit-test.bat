...
echo Compiling psp-kiq-submit-test...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\psp-kiq-submit-test.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\psp-kiq-submit-test.exe" advapi32.lib
