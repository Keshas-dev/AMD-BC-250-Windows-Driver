...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\test-basic-display.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\test-basic-display.exe" user32.lib kernel32.lib
if %errorlevel% neq 0 (echo BUILD FAILED & exit /b %errorlevel%)
echo BUILD OK
"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\test-basic-display.exe"