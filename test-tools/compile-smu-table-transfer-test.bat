...
cl /nologo /O2 /utf-8 /W3 /FeC:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\smu-table-transfer-test.exe smu-table-transfer-test.c /link /subsystem:console
