...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\tlb-inject.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\tlb-inject.exe" kernel32.lib user32.lib
