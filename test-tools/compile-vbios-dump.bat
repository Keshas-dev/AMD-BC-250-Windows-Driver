...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\vbios-dump.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\vbios-dump.exe"
