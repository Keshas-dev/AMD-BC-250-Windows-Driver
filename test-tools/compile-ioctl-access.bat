...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\test-ioctl-access.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\test-ioctl-access.exe" advapi32.lib kernel32.lib
