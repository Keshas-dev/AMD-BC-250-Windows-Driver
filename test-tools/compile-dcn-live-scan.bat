@echo off
rem compile-dcn-live-scan.bat — build dcn-live-scan.exe
setlocal
...
cl /nologo /W3 /O1 /MT /Fe"%OUTDIR%\dcn-live-scan.exe" ^
    "%SRCDIR%dcn-live-scan.c" /link user32.lib kernel32.lib
if errorlevel 1 (
    echo BUILD FAILED
    exit /b 1
)
echo OK: %OUTDIR%\dcn-live-scan.exe
