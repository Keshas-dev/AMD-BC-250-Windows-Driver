...
echo Compiling vm-offset-verify...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\vm-offset-verify.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\vm-offset-verify.exe" advapi32.lib
