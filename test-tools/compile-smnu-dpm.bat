...
cl.exe /nologo /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\smnu-dpm-test.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\smnu-dpm-test.exe"
