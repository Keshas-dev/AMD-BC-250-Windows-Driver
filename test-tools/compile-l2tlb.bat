...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\l2tlb-deep.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\l2tlb-deep.exe" advapi32.lib
