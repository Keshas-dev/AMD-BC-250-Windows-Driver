...
cl /nologo /O2 /utf-8 /W3 /FeC:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\unlock40cu-correct-grbm.exe unlock40cu-correct-grbm.c /link /subsystem:console
