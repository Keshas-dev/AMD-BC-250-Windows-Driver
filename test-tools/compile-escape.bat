...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\test-escape.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\test-escape.exe" dxgi.lib d3d11.lib d3d9.lib gdi32.lib user32.lib
