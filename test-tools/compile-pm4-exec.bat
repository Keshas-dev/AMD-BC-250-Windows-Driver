...
cl.exe /nologo /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\pm4-exec-test.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\pm4-exec-test.exe" user32.lib
