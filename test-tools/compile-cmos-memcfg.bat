...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\cmos-memcfg-test.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\cmos-memcfg-test.exe" user32.lib
