...
cl.exe /nologo /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\probe-hqd.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\probe-hqd.exe"
