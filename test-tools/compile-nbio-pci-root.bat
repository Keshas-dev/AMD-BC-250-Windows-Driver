...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\test-nbio-pci-root.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\test-nbio-pci-root.exe" user32.lib gdi32.lib
