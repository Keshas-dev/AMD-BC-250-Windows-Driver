...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\scratch-ring-test.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\scratch-ring-test.exe"
