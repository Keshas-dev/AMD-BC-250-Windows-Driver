...
for /f "delims=" %%d in ('dir /b /ad "F:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC"') do set "MSVCV=%%d"
set "MSVC=F:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\%MSVCV%"
...
cl /nologo /O2 /utf-8 /W3 /FeC:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\psp-ring-load-ip-fw-test.exe psp-ring-load-ip-fw-test.c /link /subsystem:console
