...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\vm-path-scan.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\vm-path-scan.exe" kernel32.lib user32.lib
