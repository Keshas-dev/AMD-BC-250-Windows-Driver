...
if %errorlevel% neq 0 (echo VS2022 not found on E:, trying C: & call "C:\Program Files\Microsoft Visual Studio\2022\Professional\VC\Auxiliary\Build\vcvarsall.bat" amd64 >nul 2>&1)
...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\test-nbio-unlock-detect.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\test-nbio-unlock-detect.exe" user32.lib
