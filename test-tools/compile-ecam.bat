...
cl.exe /nologo /W3 /O2 /I "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\inc" "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\test-ecam-direct.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\test-ecam-direct.exe" advapi32.lib kernel32.lib
