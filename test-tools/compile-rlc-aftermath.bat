...
cl.exe /nologo /O2 /MT /W3 /Fe"%OUTPUT_DIR%\rlc-aftermath.exe" ^
  /I"%PROJECT_DIR%\inc" ^
  "%PROJECT_DIR%\test-tools\rlc-aftermath.c" ^
  /link user32.lib
if errorlevel 1 (echo FAILED & exit /b 1) else (echo OK: output\rlc-aftermath.exe)
