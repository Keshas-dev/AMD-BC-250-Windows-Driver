...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\quick-init.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\quick-init.exe" user32.lib
