...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\iommu-gcvm-check.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\iommu-gcvm-check.exe" user32.lib gdi32.lib
