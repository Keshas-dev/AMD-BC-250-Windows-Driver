...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\bios-cmos-dump-test.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\bios-cmos-dump-test.exe" user32.lib
