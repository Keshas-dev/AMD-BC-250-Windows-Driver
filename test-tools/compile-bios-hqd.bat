...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\bios-hqd-dump.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\bios-hqd-dump.exe" kernel32.lib user32.lib
