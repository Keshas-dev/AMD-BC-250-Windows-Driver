...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\get-hw-status.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\get-hw-status.exe" user32.lib
