...
cl /nologo /O2 /utf-8 /W3 /FeC:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\psp-ring-setup-tmr-test.exe psp-ring-setup-tmr-test.c /link /subsystem:console
