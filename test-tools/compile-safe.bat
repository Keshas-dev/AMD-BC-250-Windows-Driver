...
cl.exe /nologo /W3 /O2 /I "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\inc" "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\test-smu-mailbox.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\test-safe.exe" advapi32.lib kernel32.lib
if %errorlevel% neq 0 (echo BUILD FAILED & exit /b %errorlevel%)
echo BUILD OK: test-safe.exe
