...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\vram-bar-test.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\vram-bar-test.exe" /link kernel32.lib
