...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\test-psp-loader.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\test-psp-loader.exe" user32.lib gdi32.lib
