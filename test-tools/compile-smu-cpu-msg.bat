...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\smu-cpu-msg-test.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\smu-cpu-msg-test.exe" user32.lib
