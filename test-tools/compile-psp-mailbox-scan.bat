...
cl.exe /nologo /O2 /MT /W3 /Fe"%OUTPUT_DIR%\psp-mailbox-scan.exe" ^
  /I"%PROJECT_DIR%\inc" ^
  "%PROJECT_DIR%\test-tools\psp-mailbox-scan.c" ^
  /link user32.lib

if errorlevel 1 (echo FAILED & exit /b 1) else (echo OK: output\psp-mailbox-scan.exe)
