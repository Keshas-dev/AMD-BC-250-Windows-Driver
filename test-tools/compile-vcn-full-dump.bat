...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\vcn-full-dump.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\vcn-full-dump.exe" user32.lib
