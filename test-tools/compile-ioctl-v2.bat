...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\test-ioctl-v2.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\test-ioctl-v2.exe"
