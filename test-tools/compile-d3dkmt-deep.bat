...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\test-d3dkmt-deep.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\test-d3dkmt-deep.exe" gdi32.lib user32.lib
