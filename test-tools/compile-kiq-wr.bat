...
cl.exe /nologo /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\kiq-base-writability-test.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\kiq-base-writability-test.exe" user32.lib
