...
cl.exe /nologo /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\governor-full-test.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\governor-full-test.exe"
