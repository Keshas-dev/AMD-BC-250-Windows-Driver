...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\pm4-diag.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\pm4-diag.exe" kernel32.lib user32.lib
