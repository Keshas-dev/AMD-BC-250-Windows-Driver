...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\bc250ctl.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\bc250ctl.exe" user32.lib gdi32.lib
