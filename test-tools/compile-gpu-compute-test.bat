...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\gpu-compute-test.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\gpu-compute-test.exe"
if %errorlevel% neq 0 (echo BUILD FAILED & exit /b %errorlevel%)
echo OK: output\gpu-compute-test.exe
