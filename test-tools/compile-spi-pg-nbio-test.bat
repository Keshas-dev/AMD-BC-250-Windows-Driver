...
cd /d "%~dp0"
cl /nologo /O2 /utf-8 /W3 /Fe..\output\spi-pg-nbio-test.exe spi-pg-nbio-test.c /link /subsystem:console user32.lib
if %errorlevel% equ 0 (echo BUILD OK: output\spi-pg-nbio-test.exe) else (echo BUILD FAILED)
endlocal
