...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\edid-aux-probe.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\edid-aux-probe.exe" user32.lib
