...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\pm4-via-psp-ring.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\pm4-via-psp-ring.exe"
if %errorlevel% neq 0 (echo BUILD FAILED & exit /b %errorlevel%)
echo OK: output\pm4-via-psp-ring.exe
