...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\smu-dom6-power-test.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\smu-dom6-power-test.exe" user32.lib
