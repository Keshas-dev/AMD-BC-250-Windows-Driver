/* governor-sequence-oc2000.c — governor init + change_freq to safe OC point
 * 2000 MHz @ 1000 mV (VID=88). Same proven Q0/Q3 sequence as governor-sequence.c.
 * Safe point per elektricM/amd-bc250-docs overclocking table.
 */
#include <windows.h>
#include <stdio.h>
#include <stdint.h>
...
int main(){
    ...
    printf("=== Governor OC2000 Sequence (2000 MHz @ 1000 mV) ===\n");
    ...
    /* 4. change_freq: profile -> voltage -> freq (safe OC point 2000MHz/1000mV) */
    int target_mhz=2000; int target_mv=1000;
    ...
    if(r!=1){
        ...
        if(r!=1){printf("FAIL: even 1500MHz failed\n");CloseHandle(h);return 1;}}
    Sleep(200);
    ...
    else printf("Freq unchanged at %u (target %u)\n",freq2,target_mhz);
