...
cl.exe /nologo /W3 /O2 "C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\test-tools\gfx-ring-ro-test.c" /Fe"C:\AMD-BC-250\AMD-BC-250-Windows-Driver-main\output\gfx-ring-ro-test.exe" user32.lib gdi32.lib
